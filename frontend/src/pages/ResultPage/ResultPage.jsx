    ...
    <PageContainer>
      <div className="result-page">
        ...
        <div className={`result-page__icon result-page__icon--${scoreStatus}`}>
          ...
          {scoreStatus === "unsafe" && <img src={thumbsDownIcon} alt="Thumbs down icon" className="result-page__thumbs-icon" />}
        </div>
        ...
        <div className="result-page__content">
            <aside className="result-page__side-actions">
              <button type="button" onClick={() => navigate(ROUTES.HOME)} disabled={isSubmitting}>
                <img src={arrowIcon} alt="Arrow icon" className="result-page__arrow-icon" />
              </button>
              ...
              >
                <img src={cameraIcon} alt="Camera icon" className="result-page__camera-icon" />
              </button>
              ...
              >
                <img src={fileIcon} alt="File icon" className="result-page__file-icon" />
              </button>
